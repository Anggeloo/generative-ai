...
PROJECT_ID = "qwiklabs-gcp-02-e24feeeb0775"  # Your Google Cloud Project ID
LOCATION = "us-east1"  # Your Google Cloud Project Region
...
# Código Streamlit para la selección de vino
wine = st.selectbox(
    "¿Cuál es tu preferencia de vino?",
    ["Tinto", "Blanco", "Ninguno"],
    index=0
)
